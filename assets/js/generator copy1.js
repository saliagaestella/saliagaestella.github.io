...
/*issues UX: 
        ...
        /* 1.1 ...Current Chain f(x)... */
async function currentChain(chainId2,networkBtnId,isMainnet,value){ //tarda unos 2segs en cargar, meter un loading o algo asi a lo mejor
    ...
    property.style.backgroundColor = "red";//"#FF5733 ";
...
async function login(element,provider) {
    ...
    const user = await Moralis.authenticate({
        ...
        access = true;
        address = account;
        setTimeout(function(){chainId2 = Moralis.getChainId()}, 2000); //2900 y 3000
        setTimeout(() => currentChain(chainId2,networkBtnId),2050);
        //chainId2 = chainId;
        //currentChain(chainId2,networkBtnId)
        console.log("hello");
        console.log(user);
        console.log(address);
      });
