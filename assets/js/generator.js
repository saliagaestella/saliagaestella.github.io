...
async function login(element,provider) {
    ...
    const user = await Moralis.authenticate({
        ...
        document.getElementById("menu-btn-login").innerHTML = "CONNECTED"
        document.getElementById("menu-btn-login").style.backgroundColor = "green";
        chainId2 = chainId;
      ...
      return access, account, chainId, address, user, ethers_instance
    }
 // Example -> handleAuth('metamask')
...
async function switchNetwork(element, networkName) {
  ...
  if (error === false) {
    ...
    setTimeout(() => currentChain(chainId2),2050);
    }
}}
...
function setValue(chainId2){
    ...
    value2 = (chainId2 === '0x13881') ? web3.utils.toWei('0') : (chainId2 === '0x61') ? web3.utils.toWei('0') : (chainId2 === '0x5') ? web3.utils.toWei('0') : 
    (chainId2 === '0x89') ? web3.utils.toWei('119.44') : (chainId2 === '0x38') ? web3.utils.toWei('0.0037') : (chainId2 === '0x1') ? web3.utils.toWei('0.00074') : 'other';
    console.log(value2);
    return value2;
}
